<?php include '../header.php' ?>
  ...
  <div class="w3-bar-block">
    ...
    <a href="dashboard.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-dashboard fa-fw"></i>  Dashboard</a>
    ...
    <div id="demoAcc" class="w3-hide w3-white w3-card-4">
      ...
      <a href="./" class="w3-bar-item w3-button w3-red">Alat Sewa</a>
    </div>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <div class="w3-container">
    <div class="w3-responsive">
      ...
      <a href="tambah-alat-sewa.php" class="w3-button w3-red">Tambah +</a>
      <table class="w3-table-all">
        ...
        <tr>
          ...
          <td>
            <a href="edit-alat-sewa.php?id_alat=<?php echo $tda['id_alat']; ?>" class="w3-button w3-red">Edit</a>
            <a href="delete.php?id_alat=<?php echo $tda['id_alat']; ?>" class="w3-button w3-red">Hapus!</a>
          </td>
        </tr>
        <?php
        }
