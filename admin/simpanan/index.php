<?php include '../header.php' ?>
  ...
  <div class="w3-bar-block">
    ...
    <a href="../alat-sewa/" class="w3-bar-item w3-button w3-padding"><i class="fa fa-check-circle fa-fw"></i>  Review Data & Previkasi</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <div class="w3-container">
    <div class="w3-responsive">
      <h5>Data Simpanan</h5>
      <a href="tambah-simpanan.php" class="w3-button w3-red">Tambah +</a>
      <table class="w3-table-all">
        ...
        <tr>
          ...
          <td>
            <a href="edit-simpanan.php?no_simpanan=<?php echo $tds['no_simpanan']; ?>" class="w3-button w3-red">Edit</a>
            <a href="delete.php?no_simpanan=<?php echo $tds['no_simpanan']; ?>" class="w3-button w3-red">Hapus!</a>
          </td>
        </tr>
        <?php
        }
